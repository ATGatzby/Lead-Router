...
import { Plus, Copy, Check, Trash2, Key, Terminal, AlertTriangle, Server } from "lucide-react";
...
export default function McpServerPage() {
  ...
  if (isFree) {
    return (
      <div className="relative max-w-4xl min-h-[60vh]">
        <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
          <div className="pointer-events-auto max-w-sm text-center px-8 py-8 rounded-2xl bg-white dark:bg-gray-900 border shadow-2xl shadow-violet-500/10">
            ...
            <h3 className="text-lg font-semibold mb-2">MCP Server requires Pro</h3>
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              Connect Claude Desktop or any MCP client to your Lead Routing instance with API token authentication.
            </p>
            <a
